                ...
                children.map(({attributes:{
                    ...
                    <div className={styles.area} key={index}>
                        ...
                        <div className={styles['area-row']}>
                            ...
                            <Input
                                value={title}
                                className={styles.content} placeholder="请输入标题"
                        ...
                        <div className={styles['area-row']}>
                            ...
                            <Input
                                value={description}
                                className={styles.content} placeholder="请输入描述"
                        ...
                        <div className={styles['area-row']}>
                            ...
                            <Input
                                value={imageUrl}
                                className={styles.content} placeholder="请输入图片地址"
                        ...
                        <div className={styles['area-row']}>
                            ...
                            <Input
                                value={link}
                                className={styles.content} placeholder="请输入跳转链接"
