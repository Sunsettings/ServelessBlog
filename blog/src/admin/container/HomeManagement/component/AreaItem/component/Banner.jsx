    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles['attribute-row']}>
                ...
                <Input
                    value={title}
                    className={styles.content} placeholder="请输入页面标题"
            ...
            <div className={styles['attribute-row']}>
                ...
                <Switch checked={showSmallPic} onChange={handleShowSmallPicChange}></Switch>
            </div>
            {
                showSmallPic ? (
                    <div className={styles['attribute-row']}>
                        ...
                        <Input
                            value={smallPicUrl}
                            className={styles.content} placeholder="请输入小图片的URL地址"
            ...
            <div className={styles['attribute-row']}>
                ...
                <Input
                    value={backgroundUrl}
                    className={styles.content} placeholder="请输入背景图片的URL地址"
            ...
            <div className={styles['attribute-row']}>
                ...
                <Input
                    ...
                    className={styles.content} placeholder="请输入背景高度的像素值"
